...
success_background = pygame.transform.scale(success_background, (150, 150))

#failure_image = pygame.image.load("failure_image").convert()
#failure_image = pygame.transform.scale(failure_image, (display_width, display_height))
...
def success_loop():
    ...
    while not gameExit:
        ...
        gameDisplay.fill(white)
        gameDisplay.blit(success_background, [100, 100])
     ...
     #   for event in pygame.event.get():
      #      if event.type == pygame.QUIT:
       #         pygame.quit()
        ...
        #gameDisplay.blit(failure_image, [0,0])
